...
export class LoginComponent {
  ...
  login(loginData: User) {
    if (
      loginData.email.startsWith('@gmail.com') ||
      loginData.email.startsWith('@digital-edify.com')
    ) {
      this.status = 'login Failed';
      this.warning = 'email cannot start with an address';
    } else if (loginData.email.endsWith('.com')) {
      ...
      this.status = 'login Failed';
      this.warning = 'email should end with .com domain';
    }
